...
// 嵌入图标资源（使用 @2x 版本，在 Retina 屏上显示为标准 22pt 菜单栏尺寸）
static ICON_DISCONNECTED: &[u8] = include_bytes!("../../icons/iconTemplate@2x.png");
static ICON_CONNECTED: &[u8] = include_bytes!("../../icons/iconConnectedTemplate@2x.png");
...
fn get_cursor_position() -> (f64, f64) {
    #[cfg(target_os = "macos")]
    {
        ...
        unsafe {
            ...
            CFRelease(event);
            // CGEvent 返回的是全局物理坐标（左上角原点），可直接使用
            (point.x, point.y)
        }
    }
