...
### iOS 端
重构完成（2026-03-11 审查通过）。代码从 18 文件/4808 行精简至 14 文件/2997 行。主要完成：移除语音功能（删除 VolcanoASRManager）、合并双通道为 ConnectionManager 统一架构、迁移密钥至 Keychain、补齐屏幕常亮/自动变暗/远程控制/自动切换设备/暗黑模式/使用说明等功能、ATS 恢复严格模式。
